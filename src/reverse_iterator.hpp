...
/*   Updated: 2021/01/20 16:57:42 by rlucas        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft {
		...
		class ReverseIterator {
			...
			public:
				...
				operator	const_type() const {
					...
					return (ReverseIterator<typename iterator_type::const_type>(c_it));
				}
		};
	...
	template <typename Iter>
		typename ReverseIterator<Iter>::difference_type operator-(
